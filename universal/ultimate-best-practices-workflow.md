...
*   **Best Practices:**
    ...
    5. **Continuous Improvement:** Apply `kaizen` principles for iterative code quality improvements. Use Severity-Tiered Code Review (Blocker/Major/Minor/Nit) for structured severity-rated code audits.
...
*   **Best Practices:**
    ...
    4. **Theming:** Use Design Theme Presets for pre-set theme application. Support light/dark modes via token-driven contrast.
...
*   **Best Practices:**
    ...
    4. Apply `Test-Driven Development (Red-Green-Refactor)` test-driven development for all critical path logic (Red → Green → Refactor).

## 8. Code Review & Audit
*   **Best Practices:**
    1. Use Severity-Tiered Code Review (Blocker/Major/Minor/Nit) for severity-rated code quality audits (Blocker / Major / Minor / Nit).
    2. Use Concise 1-Line Actionable Review for terse, one-line-per-finding review feedback.
    3. Use Anti-Overengineering & Bloat Audit to flag over-engineering, speculative abstractions, and unnecessary wrappers.
    4. Use `Codebase Bloat & Dead Code Audit` and `Technical Debt Tracking` to scan for deferred technical debt and code bloat.

---

## Cross-Cutting Concerns
*   **Research:** Use Web Search, official library documentation, and `perplexity-ask` for best-practice research and framework documentation.
*   **Memory:** Use Persistent Project Memory / Scratchpad to persist best-practice decisions and code quality standards across conversations.
