...
*   **Action:**
    ...
    4. Run Strict Linting & Type Validation on generated stubs to ensure type consistency and zero compilation errors.
...
*   **Research:** Use Web Search, official library documentation for verifying API framework documentation and version compatibility.
*   **Testing:** Use Playwright / Headless Browser Automation for E2E API flow testing and `Test-Driven Development (Red-Green-Refactor)` for contract test coverage.
