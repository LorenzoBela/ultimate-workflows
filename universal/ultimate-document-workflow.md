...
*   **Action:**
    ...
    4. Apply `Brand Voice & Identity System` guidelines for branded document templates (logo placement, color scheme, tone of voice).
    5. Use Design Theme Presets to apply pre-set visual themes (colors, fonts, spacing) to document layouts.
...
*   **Action:**
    ...
    5. Align document design tokens (colors, spacing, typography) with `Three-Tier Design Token Architecture` token architecture.
...
*   **Action:**
    ...
    5. Run Strict Linting & Type Validation on generated XML to verify structural integrity before repacking.
...
*   **Research:** Use Web Search and official library documentation for docx-js API documentation and OOXML specification references.
*   **Memory:** Use Persistent Project Memory / Scratchpad to persist document template configurations and style decisions across conversations.
*   **Presentations:** Use Data Presentation & Deck Layouts for generating companion HTML presentations alongside formal documents.
*   **Banner Design:** Use Hero Graphic & Banner Design for creating cover pages, headers, and branded visual elements within documents.
