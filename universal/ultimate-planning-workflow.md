...
### 1. Planning Skill Rules (`Atomic Step-by-Step Implementation Planning`)
...
### 2. Scoping Guidelines (`Structured Brainstorming & Architecture Scoping`)
...
### 4. Agent Execution Loops & Task Orchestration (`Automated Development Pipeline`)
...
### 5. Automated Validation & Scripting (`Python Automation Pipeline`)
...
*   **Memory:** Use Persistent Project Memory / Scratchpad to persist plans and architectural decisions across conversations.
