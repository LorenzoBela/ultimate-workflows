...
*   **Sub-skills:** `postgres-best-practices`
*   **MCP Tools:** `supabase-mcp-server/list_tables`, `supabase-mcp-server/list_extensions`, `prisma-mcp-server/migrate-status`
*   **Action:**
...
*   **Sub-skills:** `postgres-best-practices`
*   **MCP Tools:** `supabase-mcp-server/apply_migration`, `supabase-mcp-server/list_migrations`, `prisma-mcp-server/migrate-dev`, `prisma-mcp-server/migrate-reset`
*   **Action:**
    1. **Migration rules:**
...
*   **Sub-skills:** `postgres-best-practices`
*   **MCP Tools:** `supabase-mcp-server/execute_sql`, `supabase-mcp-server/get_advisors`
*   **Action:**
...
*   **Sub-skills:** `postgres-best-practices`, `systematic-debugging`
*   **MCP Tools:** `supabase-mcp-server/execute_sql`
*   **Action:**
...
*   **Sub-skills:** `postgres-best-practices`, `ultimate-security-workflow`, `upstash-ratelimit-js`
*   **MCP Tools:** `supabase-mcp-server/execute_sql`, `supabase-mcp-server/get_advisors`, `firebase-mcp-server/firebase_get_security_rules`
*   **Action:**
...
*   **Sub-skills:** `postgres-best-practices`, `upstash-redis-js`, `upstash-redis-start`
...
### 1. Database Best Practices Priority Rules (`postgres-best-practices`)
...
*   **Research:** Use `tavily-search`, `context7/get-library-docs`, and `perplexity-ask` for Postgres documentation, indexing strategies, and query optimization techniques.
*   **Memory:** Use `memory` MCP to persist schema decisions, constraint rationale, and indexing strategies across conversations.
