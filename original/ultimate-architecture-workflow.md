...
*   **Sub-skills:** `sequential-thinking/sequentialthinking`, `superpowers-brainstorm`, `concise-planning`
*   **Action:**
    ...
    5. Use `superpowers-brainstorm` to evaluate alternative domain decompositions with pros/cons matrices.

### Phase 2: Database Schema & Entity-Relationship Modeling
*   **Sub-skills:** `supabase-postgres-best-practices`, `ultimate-database-workflow`, `upstash-vector-js`, `upstash-search-js`
*   **Action:**
    ...
    5. Apply `supabase-postgres-best-practices` for constraint design, indexing strategy, and connection pooling.

### Phase 3: API & Component Interaction Design
*   **Sub-skills:** `ultimate-api-workflow`, `ultimate-fullstack-workflow`, `upstash-workflow-js`, `upstash-qstash-js`
*   **Action:**
...
*   **Sub-skills:** `ultimate-documentation-workflow`, `docx`, `memory`
*   **Action:**
...
*   **Research:** Use `tavily-search`, `tavily-research`, `perplexity-ask`, and `context7/get-library-docs` for architecture pattern research.
...
*   **Brand Alignment:** For customer-facing architectures, reference `ckm:brand` and `Awesome-Design-MD` brand guidelines.
