...
*   **Sub-skills:** `concise-planning`, `ultimate-architecture-workflow`
*   **Action:**
...
*   **Sub-skills:** `lint-and-validate`, `superpowers-tdd`
*   **Action:**
    ...
    4. Run `lint-and-validate` across all workspace packages to ensure cross-package type consistency.
    5. Use `superpowers-tdd` for shared package unit testing with isolated test configurations.

### Phase 3: Shared Dependency Management
*   **Sub-skills:** `kaizen`, `ponytail`
*   **Action:**
...
*   **Sub-skills:** `ultimate-git-workflow`, `caveman-commit`, `git-pushing`, `ultimate-deployment-workflow`
*   **Action:**
    ...
    4. Use `caveman-commit` for terse, conventional commit messages across packages.
    5. Use `git-pushing` for safe remote pushes and `ultimate-deployment-workflow` for CI/CD pipeline integration.

---

## Cross-Cutting Concerns
*   **Research:** Use `tavily-search` and `context7/get-library-docs` for Turborepo/Nx/pnpm workspace documentation.
*   **Memory:** Use `memory` MCP to persist workspace architecture decisions and package relationships.
